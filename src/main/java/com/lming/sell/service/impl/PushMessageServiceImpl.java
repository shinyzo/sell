...
import com.lming.sell.config.WechatAccountConfig;
import com.lming.sell.dto.OrderDTO;
import com.lming.sell.service.PushMessageService;
...
public class PushMessageServiceImpl implements PushMessageService{
    ...
    public void orderStatus(OrderDTO orderDTO) {
        ...
        wxMpTemplateMessage.setData(Arrays.asList(
                ...
                new WxMpTemplateData("keyword2","400-200-600"),
